...
<div id="cat-manage" class="row">
    ...
    <div class="col-lg-12">
        ...
        <form class="" method="POST" action="{{route('admin.page.massdel')}}">
            {!! csrf_field() !!}
                ...
                <table class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.page.edit', $post->id)}}" class="btn btn-info btn-sm item-edit" title="Chỉnh sửa"><span class="fa fa-pencil"></span></a>  
                                <a href="{{route('admin.page.delete', $post->id)}}" class="btn btn-danger btn-sm item-delete" title="Xóa"><span class="fa fa-close"></span></a>
                            </td>
                        </tr>
                        @endforeach
                        @endif
            ...
            <a href="{{route('admin.page.create')}}" class="btn btn-success"><span class="fa fa-plus"></span> Thêm mới</a>
