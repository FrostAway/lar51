...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="vf_form">
            ...
            @if($type == 'cat')
            <form class="form-horizontal" method="POST" action="{{route('admin.cat.update', $cat->id)}}">
                {!! csrf_field() !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="parent" class="form-control">
                            ...
                            @foreach($cats as $ca)
                            <option value="{{$ca->id}}" <?php selected($ca->id, $cat->id) ?>>{{$ca->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="order" value="{{$cat->order}}" class="form-control" placeholder="" />
                    </div>
                </div>
                <div class="form-group">
            ...
            @else
            <form class="form-horizontal" method="POST" action="{{route('admin.tag.update', $cat->id)}}">
                {!! csrf_field() !!}
