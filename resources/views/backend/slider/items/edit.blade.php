            ...
            {!! Form::model($slide, [
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        {!! Form::text('slider_name', $currslider->name, ['class' => 'form-control', 'disabled']) !!}
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="media-choose">
                                {!! Form::hidden('image', null, ['id' => 'media-url']) !!}
                                <img src="{{ asset($slide->image) }}" class="media-image img-responsive" alt="Hình ảnh" />
                ...
                <div class="form-group">
                    <div class="col-sm-10 col-sm-offset-2">
                        <input type="submit" name="create_slide" class="btn btn-success" value="Cập nhật" />
